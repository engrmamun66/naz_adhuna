<div class="main_page_content" id="admin_users_add">
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active">Edit Editor</span>
        </li>
    </ul>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold">Edit Editor</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            <a class="btn btn-sm green" href="/admin/aboutus/editor" >
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active">
                            ...
                            <div class="margiv-top-10">
                                ...
                                <a href="/admin/aboutus/editor" class="btn default"> Cancel </a>
                            </div>
