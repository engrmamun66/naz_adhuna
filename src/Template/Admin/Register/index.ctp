    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                <!-- <a href="/admin/register/update/<?php echo $ad['id'];?>" class="btn btn-outline btn-circle btn-xs purple">Update</a>  -->
                <a href="/admin/register/delete/<?php echo $ad['id'];?>" class="btn btn-outline btn-circle btn-xs red">Delete</a>
            </td>
        </tr>
    <?php }?>
    </tbody>
